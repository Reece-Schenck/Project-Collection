...
class System extends Hardware_1.Hardware {
    constructor(name) {
        ...
        this._MMU = new Mmu_1.Mmu(memorySizeInBytes);
        this._CPU = new Cpu_1.Cpu(name, this._MMU, this);
        this._Memory = new Memory_1.Memory(memorySizeInBytes);
        // irq = 1, priority = 10
        this._Keyboard = new Keyboard_1.Keyboard(1, 10, 'keyboard', this._InterruptController);
        /*
    ...
    startSystem() {
        ...
        */
        ...
        const clock = new Clock_1.Clock("clock");
        // 1 second interval
...
let system = new System("Test System");
